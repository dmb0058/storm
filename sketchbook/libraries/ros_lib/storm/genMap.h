#ifndef _ROS_SERVICE_genMap_h
#define _ROS_SERVICE_genMap_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GENMAP[] = "storm/genMap";

  class genMapRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return GENMAP; };
    const char * getMD5(){ return "9aeb2245d9611f300beeb62a0151d3f3"; };

  };

  class genMapResponse : public ros::Msg
  {
    public:
  ...
  class genMap {
    public:
    typedef genMapRequest Request;
    typedef genMapResponse Response;
  };
